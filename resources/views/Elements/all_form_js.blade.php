...
<script src="<?php echo BASE_PATH ?>plugins/bootstrap/js/bootstrap.js"></script>
<script src="<?php echo BASE_PATH ?>plugins/bootstrap/js/bootstrap.min.js"></script>
...
<script src="<?php echo BASE_PATH ?>plugins/jquery-validation/jquery.validate.js"></script>
<script src="<?php echo BASE_PATH ?>plugins/jquery-validation/additional-methods.min.js"></script>
...
<script src="<?php echo BASE_PATH ?>plugins/select2/js/select2.js"></script>
<script src="<?php echo BASE_PATH ?>plugins/select2/js/select2.min.js"></script>
<script src="<?php echo BASE_PATH ?>plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.js"></script>
